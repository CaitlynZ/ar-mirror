...
public class MapTexture1 : MonoBehaviour
{
    MeshFilter cubeMesh;
    Mesh mesh;
    ...
    void Start()
    {
        ...
        mesh = cubeMesh.mesh;        
        Vector2[] uvMap = mesh.uv;          // Using Vector2 instead of Vector3 to only deal with x and y
